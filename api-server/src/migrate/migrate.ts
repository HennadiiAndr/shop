...
export async function migrate(args: string[]) {
  ...
  await app.migrateSchema({ existingSchema, models: [ 'ProductFeatures'] });
  await app.migrateSchema({ existingSchema, models: [ 'Property'] });
  await app.migrateSchema({ existingSchema, models: [ 'PropertyValues'] });
  await app.migrateSchema({ existingSchema, models: [ 'ProductProperties'] });
